...
pl.xticks(pl.xticks()[0],[str(a/1000.) for a in pl.xticks()[0]])
#pl.xticks([])
ax.set_xlim([start, end])
pl.tight_layout()
pl.subplots_adjust(left = .06, bottom=.06, right=.98, top=.99)
pl.savefig('snippet_zoom.png', bbox_inches='tight', dpi=800)
pl.savefig('snippet_zoom.pdf', bbox_inches='tight', dpi=400)
pl.savefig('snippet_zoom.tiff', bbox_inches='tight', dpi=400)
pl.show()
